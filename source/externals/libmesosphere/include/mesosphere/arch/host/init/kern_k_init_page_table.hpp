...
#include <mesosphere/arch/host/kern_k_page_table_entry.hpp>
#include <mesosphere/kern_select_system_control.hpp>

namespace ams::kern::arch::host::init {
    ...
    class KInitialPageTable {
        ...
        public:
            ...
            ALWAYS_INLINE uintptr_t GetTtbr0L1TableAddress() const {
                return GetInteger(m_l1_tables[0]);
            }

            ALWAYS_INLINE uintptr_t GetTtbr1L1TableAddress() const {
                return GetInteger(m_l1_tables[1]);
            }
        private:
            ALWAYS_INLINE L1PageTableEntry *GetL1Entry(KVirtualAddress address, u64 phys_to_virt_offset = 0) const {
            ...
            static ALWAYS_INLINE L2PageTableEntry *GetL2Entry(const L1PageTableEntry *entry, KVirtualAddress address, u64 phys_to_virt_offset = 0) {
            ...
            static ALWAYS_INLINE L3PageTableEntry *GetL3Entry(const L2PageTableEntry *entry, KVirtualAddress address, u64 phys_to_virt_offset = 0) {
